define( function(){
	...
	var singleMedia = 	'<div class="media-small-border">\
			        	{{^videoURL}}\
			          	...
			          	{{/videoURL}}\
			          	{{#videoURL}}\
							<video id="{{itemId}}_video" class="video-js vjs-big-play-centered vjs-default-skin video-16x9" controls preload="none" poster="{{imageURL}}">\
